...
<script type="text/javascript">
    ...
    function save(){
    	$.ajax({
			 url:"${ctx}/dictionary/doSaveOrUpdateRateResult",
			 data : $("#rateResultForm").serialize(),
			 type : "POST",
     ...
     <div class="col-sm-12">
         <div class="ibox float-e-margins">
             <div class="ibox-title">
                 <h5>字典管理<span>／</span>评级结果</h5>
             </div>
             <form id="rateResultForm" method="post" action="">
             	 <input id="id" name="id" type="hidden" value="${rateResult.id}">
	             <div width="100%" class="audit_parent">
	                 <table style="margin-left: 50px;" id="" class="tb">
						 <tr>
						 	 <td>评级结果名称：</td>
							 <td>
							 	<input id="name" name="name" type="text" value="${rateResult.name}" />
							 </td>
						 </tr>
					 </table>
	         	 </div>
