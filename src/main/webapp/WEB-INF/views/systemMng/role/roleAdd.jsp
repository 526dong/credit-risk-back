...
function saveAddSysRole(){
	if($("#sysRoleAddForm").valid()){
		$.ajax({
			url : "${ctx}/role/saveSysRoleAdd",
			type : 'POST',
			data : {
					"name":$("#name").val(),
    ...
    <div class="main_center">
        ...
        <div class="right_content">
            <h3 class="place_title">
                ...
                <span>></span>
                <a href="${ctx }/role/toSysRoleAddPage">创建角色</a>
            </h3>
            <div class="backtrack">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input_btn clear">
                                            <a href="javaScript:saveAddSysRole();" class="fl makeSure">保存</a>
            ...
            <div class="footer">
                <div class="main_footer clear">
                    <p class="fl">中诚信征信有限公司</p>
                    <p class="fr">京ICP备08007112号-1</p>
                </div>
            </div>
            <!-- footer.html end -->
        </div>
