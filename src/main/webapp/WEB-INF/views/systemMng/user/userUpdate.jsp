...
$(function() {
	...
	$.validator.addMethod("isOnlyLoginName", function(value,element) {
		...
		var oldLoginName = "${userVoBg.loginName }";
		var ok = false;
		if(oldLoginName != loginName){
			$.ajax({
	    		url: "${ctx}/user/isOnlyLoginName",
		        data: JSON.stringify(
		        	{
		        		"loginName":value
		        	}
...
function saveUpdateUser(){
	if($("#userUpdateForm").valid()){
		$.ajax({
			url : "${ctx}/user/saveUpdateSysUser",
			type : 'POST',
			data : JSON.stringify(
				{
					"userId":$("#userId").val(),
    ...
    <div class="main_center">
        ...
        <div class="right_content">
            <h3 class="place_title">
                ...
                <span>></span>
                <a href="${ctx}/user/toEditSysUserPage?userId=${userId }">修改用户信息</a>
            </h3>
            <div class="backtrack">
...
<!--                                     <td><p class="myError_info" id="loginName_error"></p></td> -->
                                ...
                                <tr>
                                    ...
                                    <td><input value="${userVoBg.name }" type="text" id="name" name="name" placeholder="请输入姓名" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" /></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="down_menu">
                                            ...
                                            <input value="${userVoBg.roleId }" type="hidden" id="roleId"  name="roleId" >
                                                <span data-id="${userVoBg.roleId }">${userVoBg.roleName }</span>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <input value="${userVoBg.phone }" type="text" id="phone" name="phone" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input value="${userVoBg.email }" type="text" id="email" name="email" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input_btn clear">
                                            ...
                                            <a href="${ctx}/user/manager" class="fr cancel">取消</a>
                                        </div>
                                    </td>
                                </tr>
