 ...
 * @Author:       zhaotm 
 * @CreateDate:   2017/8/25 15:54  
 * @Version:      v1.0
 */

import com.ccx.index.model.ReportVo;
import org.springframework.web.servlet.ModelAndView;

import java.util.ArrayList;
import java.util.List;

public class RateColumnTest {
    public static void main(String[] args) {
        RateColumnTest test = new RateColumnTest();
       /* test.fun1();
        test.fun2();
        test.fun3();
        test.fun4();
    ...
    /*public void fun1() {
        try {
            Class<?> c = Class.forName("com.ccx.enterprise.model.ReportAsset");
            List<ReportVo> list = this.prepareReportAssetDiv(null);
            for (ReportVo reportVo : list) {
                String name1 = "xxbegin_"+reportVo.getColumn();
                String name2 = "xxend_"+reportVo.getColumn();
                try {
                    c.getDeclaredMethod("get"+EnterpriseRatingUtils.getMethodName(name1));
                    c.getDeclaredMethod("get"+EnterpriseRatingUtils.getMethodName(name2));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        System.out.println("fun1() OK");
    }
    public void fun2() {
        try {
            Class<?> c = Class.forName("com.ccx.enterprise.model.ReportLiabilitiesEquites");
            List<ReportVo> list = this.prepareReportLeDiv(null);
            for (ReportVo reportVo : list) {
                String name1 = "xxbegin_"+reportVo.getColumn();
                String name2 = "xxend_"+reportVo.getColumn();
                try {
        ...
        System.out.println("fun2() OK");
    }
    public void fun3() {
        try {
            Class<?> c = Class.forName("com.ccx.enterprise.model.ReportProfitLoss");
            List<ReportVo> list = this.prepareReportProfitLossDiv(null);
            for (ReportVo reportVo : list) {
                String name1 = "xxbegin_"+reportVo.getColumn();
                String name2 = "xxend_"+reportVo.getColumn();
                try {
        ...
        System.out.println("fun3() OK");
    }
    public void fun4() {
        try {
            Class<?> c = Class.forName("com.ccx.enterprise.model.ReportCashFlow");
            List<ReportVo> list = this.prepareReportCashFlowDiv(null);
            for (ReportVo reportVo : list) {
                String name1 = "xxbegin_"+reportVo.getColumn();
                String name2 = "xxend_"+reportVo.getColumn();
                try {
        ...
        System.out.println("fun4() OK");
    }
    public void fun5() {
        try {
            Class<?> c = Class.forName("com.ccx.enterprise.model.ReportAdditionalCashFlow");
            List<ReportVo> list = this.prepareReportACFDiv(null);
            for (ReportVo reportVo : list) {
                String name1 = "xxbegin_"+reportVo.getColumn();
                String name2 = "xxend_"+reportVo.getColumn();
                try {
        ...
        System.out.println("fun5() OK");
    }
    public void fun6() {
        try {
            Class<?> c = Class.forName("com.ccx.enterprise.model.ReportNotesFinancialStatement");
            List<ReportVo> list = this.prepareReportNFSDiv(null);
            for (ReportVo reportVo : list) {
                String name1 = "xxbegin_"+reportVo.getColumn();
                String name2 = "xxend_"+reportVo.getColumn();
                try {
        ...
        System.out.println("fun6() OK");
    }*/


    public List<ReportVo> prepareReportAssetDiv(ModelAndView mnv) {
        ...
        return this.getReportVOList(sb);
    }

    public List<ReportVo> prepareReportLeDiv(ModelAndView mnv) {
        StringBuilder sb = new StringBuilder();
    ...
    public List<ReportVo> prepareReportProfitLossDiv(ModelAndView mnv) {
        StringBuilder sb = new StringBuilder();
    ...
    public List<ReportVo> prepareReportCashFlowDiv(ModelAndView mnv) {
        StringBuilder sb = new StringBuilder();
    ...
    public List<ReportVo> prepareReportACFDiv(ModelAndView mnv) {
        StringBuilder sb = new StringBuilder();
    ...
    public List<ReportVo> prepareReportNFSDiv(ModelAndView mnv) {
        StringBuilder sb = new StringBuilder();
    ...
    public List<ReportVo> getReportVOList(StringBuilder sb) {
