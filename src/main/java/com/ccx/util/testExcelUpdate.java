...
public class testExcelUpdate {
	  ...
	  * @throws
	  */
    public static void updateExcel(String filePath,String updateValue,int updateSheetIndex,int startCellIndex,int endCellIndex,int startRowIndex,int endRowIndex){
    	try { 
    ...
    public static void main(String[] args) throws Exception{
        ...
        int endCellIndex = 40;//结束更新的行数下标
        int startRowIndex = 2;//开始更新的列数下标
        int endRowIndex = 7;//结束更新的列数下标
        //path:路径  
        //updateValue:要修改的数据
