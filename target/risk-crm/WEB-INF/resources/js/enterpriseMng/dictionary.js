            ...
            for (var i=0;i<indexList.length;i++){
                ...
                if (1 == editShowType || 2  == editShowType) {
                    ...
                    if (2 == editShowType) {
                        ...
                        1 == editShowType
                        trHtml += "<div class='col-lg-4 col-md-4 col-sm-4'>";
                    }
                    if (2 == editShowType) {
                        trHtml += "<div class='indicator_box fl'>";
                    } else {
                        trHtml += "<div class='indicator_box clear'>";
                    }
                    trHtml += "<input type='hidden' name='indexId' value='"+indexList[i].id+"'/>"+
                        "<strong class='fl'><i>*</i>"+indexList[i].indexName+"</strong>"+
                    ...
                    for (var j=0; j<ruleList.length; j++) {
                        //遍历规则
                        if (indexRuleMap[indexList[i].id] == ruleList[j].id) {
                            trHtml += "<li class='active' data-id='"+ruleList[j].id+"'>"+ruleList[j].value+"</li>";

                        } else {
                            trHtml += "<li data-id='"+ruleList[j].id+"'>"+ruleList[j].value+"</li>";
                        }
                    }
                    trHtml += "</ul>"+
                        "</div>"+//select_parent fl
                        "</div>";//indicator_box clear
                    if (2 == editShowType) {
                    ...
                    trHtml += "</div>";//col-lg-4 col-md-4 col-sm-4
                    ...
                    trHtml +=    "<div class='indicator_box clear'>"+
                        "<strong class='fl'>"+indexList[i].indexName;
                    ...
                    trHtml += "</div>"+//indicator_box clear
