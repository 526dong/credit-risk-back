...
<title>客户管理-账号管理-角色管理-修改角色信息 </title>
...
function saveAddRole(){
	if($("#insRoleUpdateForm").valid()){
		$.ajax({
			url : "${ctx}/custom/saveInsRoleEdit",
			type : 'POST',
			data : {
					"id":$("#roleId").val(),
					"name":$("#name").val(),
    ...
    <div class="main_center">
        ...
        <div class="right_content">
            <h3 class="place_title">
                ...
                <span>></span>
                <a href="${ctx}/custom/toInsRoleUpdatePage?roleId=${roleId }&&insId=${insId }">修改角色信息</a>
            </h3>
            <div class="backtrack">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width:222px;">
                                        <input value="${roleFg.name }" type="text" id="name" name="name" placeholder="请输入角色名称" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" onkeydown="if(event.keyCode==13) return false;"/>
                                    </td>
                                ...
                                <tr style="vertical-align:top">
                                    ...
                                    <td colspan="2">
                                        ...
                                        onfocus="checkMaxInput(this,50)" onblur="checkMaxInput(this,50);">${roleFg.description }</textarea>
