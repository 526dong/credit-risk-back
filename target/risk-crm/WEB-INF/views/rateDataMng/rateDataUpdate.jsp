...
$(function(){
	...
	$(".input_table").find("tr").find("td").eq(2).css("width", "350px");
});
//select框默认选择-请选择
			...
			<div class="shade main_minHeight">
				<div class="input_list_box">
					<form id="rateDataForm">
						<input id="rateDataId" name="id" value="${rateData.id}" type="hidden" />
						<table class="input_table input_table1">
							<tbody>
							<tr>
								<td><strong>企业名称</strong></td>
								<td>
									<input id="name" name="name" value="${rateData.name}" type="text" />
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<div class="down_menu">
										<div class="select_btn">
											<span data-id="${rateData.rateResult}">${rateData.rateResultName}</span>
											<input id="rateResult" name="rateResult" type="hidden" value="${rateData.rateResult}" />
										</div>
								...
								<td>
									<p class="error_info" id="rateResultError"></p>
								</td>
							</tr>
							<tr>
								<td><strong>统一社会信用代码</strong></td>
								<td>
									<input id="creditCode" name="creditCode" type="text" value="${rateData.creditCode}" />
								</td>
								<td>
									<p class="error_info"></p>
								</td>
							...
							<tr>
								...
								<td>
									<input id="certificateCode" name="certificateCode" value="${rateData.certificateCode}" type="text" />
								</td>
								<td>
									<p class="error_info"></p>
								</td>
							...
							<tr>
								...
								<td>
									<input id="organizationCode" name="organizationCode" value="${rateData.organizationCode}" type="text" />
								</td>
								<td>
									<p class="error_info"></p>
								</td>
							...
							<tr>
								<td><strong>评级机构</strong></td>
								<td>
									<div class="down_menu">
										<div class="select_btn">
											<span data-id="${rateData.rateInstitution}">${rateData.rateInstitutionName}</span>
											<input id="rateInstitution" name="rateInstitution" type="hidden" value="${rateData.rateInstitution}" />
										</div>
							...
							<tr>
								<td><strong>评级时间</strong></td>
								<td>
									<input type="text" id="rateTime" name="rateTime" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="${rateData.rateTime}">
								</td>
								<td>
									<p class="error_info"></p>
								</td>
