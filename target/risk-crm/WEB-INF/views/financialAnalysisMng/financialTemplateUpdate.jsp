...
// 			alert("请选择报表类型！");
// 		}else{
			var reportTypeId = "${financialAnalyBean.reportTypeId}";
			var financialId = "${financialAnalyBean.id}";
	...
	<div class="main_center">
		...
		<div class="right_content">
			<h3 class="place_title">
				...
				<span>></span>
				<a href="${ctx }/financialAnaly/toUpdateFinancialTemplate?financialId=${financialAnalyBean.id}">修改</a>
			</h3>
			<div class="backtrack">
                    	...
                    	<ul class="updataRate_list">
                            <%-- <li>
                                ...
                                <div class="report_select">
                                	<input type="hidden" id="reportTypeId" value="${financialAnalyBean.reportTypeId}">
                                    <em class="select_value">${financialAnalyBean.reportTypeName}</em>
                        	...
                        	<li>
                            	<span>模板名称</span>
                                <div id="templateName">${financialAnalyBean.name}</div>
                            </li>
                            <li>
                            	<span>上传模板</span>
