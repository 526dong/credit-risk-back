    ...
    function createPage2(total, pageNo, totalpage) {
    	 if(totalpage > 1){
    		 $("#currentPage2").val(pageNo);//当前页数
    	        ...
    	        if (pageNo - 1 > 0) {
    	            pageStr += "<strong class='page_left' onclick='javaScript:jumpToPage2(" + (pageNo - 1) + ")'></strong>";
    	        }
    	        if (1 < starPage) {
    	            pageStr += "<span >...</span>";
    	        }
    	        ...
    	        if (starPage > endPage) {
    	            pageStr += "<a href='javaScript:jumpToPage2(" + pageNo + ");' >" + pageNo + "</a>";
    	        }
    	        if (endPage < totalpage) {
    	            pageStr += "<span>...</span>";
    	        }
    	        if (pageNo + 1 <= totalpage) {
    	            pageStr += "<strong class='page_right' onclick='javaScript:jumpToPage2(" + (pageNo + 1) + ")'></strong>";
    	        }
    	        pageStr += "</p>";
    	        return pageStr;
    	 }else{
...
<div class="page_parent" id="pageDiv2"></div>