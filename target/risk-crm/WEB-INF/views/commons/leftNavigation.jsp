...
function clickHeader(myselfId,index){
	...
	menuIndex2 = menuIndex2+fenGeFu+myselfId;
        	...
        	if(null!=data&&data.length>0){    
	        	for(var i = 0 ;i<data.length;i++){
	                if(parseInt(data[i].level) == 2){
	                	htmlContent += '<li>';
	                    htmlContent += '<h2>';
	                    htmlContent += '<a style="cursor: pointer;" data-id="'+obj2+'|'+myselfId+'" data-url="${ctx}'+data[i].pathUrl+'">';
	                    htmlContent += '<span class="'+data[i].iconUrl+'">';
