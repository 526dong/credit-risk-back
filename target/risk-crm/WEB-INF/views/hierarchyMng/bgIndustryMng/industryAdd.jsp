...
//保存新增
function saveAddBgInsdustry(){
	if($("#bgInsdustryForm").valid()){
		$.ajax({
			url : "${ctx}/insdustryManage/saveAddBgInsdustry",
			type : 'POST',
			data : JSON.stringify(
				{
    ...
    <div class="main_center">
        ...
        <div class="right_content">
            <h3 class="place_title">
                ...
                <span>></span>
                <a href="${ctx}/insdustryManage/toAddBgInsdustryPage">新增后台行业</a>
            </h3>
                        ...
                        <table class="input_table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input value="" type="text" id="bgInsdustryName" name="bgInsdustryName" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')" maxlength="30">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input_btn clear">
                                            <a href="javaScript:saveAddBgInsdustry();" class="fl makeSure">保存</a>
